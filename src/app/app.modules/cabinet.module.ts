...
import { CabinetFooterComponent } from '../cabinet/footer/cabinet-footer.component';
...
import { PhoneFormComponent } from '../cabinet/settings/profile/phone-form/phone-form.component';
import { EmailFormComponent } from '../cabinet/settings/profile/email-form/email-form.component';
import { SettingsPasswordComponent } from '../cabinet/settings/password/settings-password.component';
import { NoAccountComponent } from '../cabinet/common/no-account/no-account.component';

export const CABINET: any[]=[
 CabinetComponent
